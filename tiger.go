...
// // Preprocesiranje. Svodjenje poruke na dužinu koja je umnožak od
// 512 // (u bitovima). Može se uraditi bilo kako, ali dva najčešća načina
// su // dodavanje potrebnog broja nula na kraju ili sledeće:
...
//    w[1] = w[1] XOR w[0]
//    w[2] = w[2] + w[1]
//    w[3] = w[3] – (w[2] XOR ((w[1] XOR 0xFFFFFFFFFFFFFFFF)<< 19))
//    w[4] = w[4] XOR w[3]
//    w[5] = w[5] + w[4]
//    w[6] = w[6] – (w[5] XOR ((w[4] XOR 0xFFFFFFFFFFFFFFFF)>> 23))
//    w[7] = w[7] XOR w[6]
// else if i = 1 then
//    w[0] = w[0] + w[7]
//    w[1] = w[1] – (w[0] XOR ((w[0] XOR 0xFFFFFFFFFFFFFFFF)<< 19))
//    w[2] = w[2] XOR w[1]
//    w[3] = w[3] + w[2]
//    w[4] = w[4] – (w[3] XOR ((w[2] XOR 0xFFFFFFFFFFFFFFFF)>> 23))
//    w[5] = w[5] XOR w[4]
//    w[6] = w[6] + w[5]
